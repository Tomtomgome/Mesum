...
\DoxyCodeLine{119 }
\DoxyCodeLine{120     \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{KeyActionSignal::mCallbackHandle}} attach\_ToKeyEvent(}
\DoxyCodeLine{121         \mbox{\hyperlink{structm_1_1input_1_1_key_action}{KeyAction}} a\_keyAction, \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{KeyActionCallback}}\& a\_callback);}
\DoxyCodeLine{122     \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{MouseActionSignal::mCallbackHandle}} attach\_ToMouseEvent(}
\DoxyCodeLine{123         \mbox{\hyperlink{structm_1_1input_1_1_mouse_action}{MouseAction}} a\_mouseAction, \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{MouseActionCallback}}\& a\_callback);}
\DoxyCodeLine{124     \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{ScrollSignal::mCallbackHandle}} attach\_ToScrollEvent(\textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{ScrollCallback}}\& a\_callback);}
...
\DoxyCodeLine{136                               \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{MouseActionSignal::mCallbackHandle}}\& a\_handle);}
\DoxyCodeLine{137 }
\DoxyCodeLine{138     \textcolor{keywordtype}{void} detach\_FromScrollEvent(\textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{ScrollCallback}}\& a\_callback);}
\DoxyCodeLine{139     \textcolor{keywordtype}{void} detach\_FromScrollEvent(\textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{ScrollSignal::mCallbackHandle}}\& a\_callback);}
\DoxyCodeLine{140 }
\DoxyCodeLine{141     \textcolor{keywordtype}{void} detach\_FromMoveEvent(\textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{MouseMoveCallback}}\& a\_callback);}
\DoxyCodeLine{142     \textcolor{keywordtype}{void} detach\_FromMoveEvent(\textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{MouseMoveSignal::mCallbackHandle}}\& a\_callback);}
\DoxyCodeLine{143 }
\DoxyCodeLine{144     \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{MouseStateSignal::mCallbackHandle}} attach\_ToMouseState(}
\DoxyCodeLine{145         \mbox{\hyperlink{structm_1_1input_1_1_mouse_state}{MouseState}} a\_mouseState, \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{MouseStateCallback}}\& a\_callback);}
...
\DoxyCodeLine{147                               \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_callback}{MouseStateCallback}}\& a\_callback);}
...
\DoxyCodeLine{149                               \textcolor{keyword}{const} \mbox{\hyperlink{classm_1_1m_signal_aad959466bfb4da3a46ece8eb6608191b}{MouseStateSignal::mCallbackHandle}}\& a\_handle);}
\DoxyCodeLine{150 }
...
\DoxyCodeLine{165 }
\DoxyCodeLine{166     \mbox{\hyperlink{classm_1_1m_signal}{ScrollSignal}}    m\_scrollSignal;}
\DoxyCodeLine{167     \mbox{\hyperlink{classm_1_1m_signal}{MouseMoveSignal}} m\_moveSignal;}
\DoxyCodeLine{168 \};}
