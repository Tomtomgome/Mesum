...
\DoxyCodeLine{20 \{}
\DoxyCodeLine{21     \mbox{\hyperlink{structm_1_1math_1_1m_vec}{math::mVec3}} position;}
\DoxyCodeLine{22     \mbox{\hyperlink{structm_1_1math_1_1m_vec}{math::mVec4}} color;}
\DoxyCodeLine{23 \};}
\DoxyCodeLine{24 }
...
\DoxyCodeLine{27 \{}
\DoxyCodeLine{28     mUInt                  vertexBufferSize = 0;}
\DoxyCodeLine{29     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} mUInt vertexSize       = \textcolor{keyword}{sizeof}(tt\_Vertex);}
\DoxyCodeLine{30     mUInt                  indexBufferSize  = 0;}
\DoxyCodeLine{31     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} mUInt indexSize        = \textcolor{keyword}{sizeof}(tt\_Index);}
\DoxyCodeLine{32 \};}
\DoxyCodeLine{33 }
...
\DoxyCodeLine{271     \{}
\DoxyCodeLine{272         \mbox{\hyperlink{group___core_ga0bcecb82138d5f42db4089c93554f5a2}{mLog\_error}}(\textcolor{stringliteral}{"{}Could not map vertex buffer"{}});}
...
\DoxyCodeLine{276     \{}
\DoxyCodeLine{277         \mbox{\hyperlink{group___core_ga0bcecb82138d5f42db4089c93554f5a2}{mLog\_error}}(\textcolor{stringliteral}{"{}Could not map index buffer"{}});}
...
\DoxyCodeLine{312     Dx12BufferBase<BasicVertex, mU16>[dx12::DX12Surface::scm\_numFrames];}
\DoxyCodeLine{313 }
\DoxyCodeLine{314 \textcolor{keyword}{using} vulkanUploadBuffers =}
\DoxyCodeLine{315     VulkanBufferBase<BasicVertex, mU16>[vulkan::VulkanSurface::scm\_numFrames];}
\DoxyCodeLine{316 }
...
\DoxyCodeLine{334 \{}
\DoxyCodeLine{335     \mbox{\hyperlink{structm_1_1render_1_1_data_mesh_buffer}{DataMeshBuffer<BasicVertex, mU16>}}* m\_pMeshBuffer;}
...
\DoxyCodeLine{381 }
\DoxyCodeLine{382     \textcolor{keywordtype}{void} create\_renderPassAndPipeline(mU32 a\_width, mU32 a\_height);}
\DoxyCodeLine{383 }
