...
\DoxyCodeLine{348     mInt*                              m\_pMaterialID = \textcolor{keyword}{nullptr};}
...
\DoxyCodeLine{392 }
\DoxyCodeLine{393     dx12::ComPtr<ID3D12Resource> m\_pCbMatrices = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{394     \textcolor{keywordtype}{void}* m\_pCbMatricesData = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{395     dx12::ComPtr<ID3D12Resource> m\_pCbMaterial = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{396     \textcolor{keywordtype}{void}* m\_pCbMaterialData = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{397     std::vector<dx12::ComPtr<ID3D12Resource>> m\_pTextureResources\{\};}
\DoxyCodeLine{398 }
\DoxyCodeLine{399     D3D12\_GPU\_DESCRIPTOR\_HANDLE m\_GPUDescHdlTexture\{\};}
\DoxyCodeLine{400 }
\DoxyCodeLine{401     D3D12\_GPU\_DESCRIPTOR\_HANDLE m\_GPUDescHdlSampler\{\};}
\DoxyCodeLine{402 }
\DoxyCodeLine{403     dx12::ComPtr<ID3D12DescriptorHeap> m\_pSrvHeap = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{404     mUInt m\_incrementSizeSrv = 0;}
\DoxyCodeLine{405     \textcolor{keyword}{static} \textcolor{keyword}{const} mUInt sm\_sizeSrvHeap = 32;}
\DoxyCodeLine{406     dx12::ComPtr<ID3D12DescriptorHeap> m\_pSamplerHeap = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{407     mUInt m\_incrementSizeSampler = 0;}
\DoxyCodeLine{408     \textcolor{keyword}{static} \textcolor{keyword}{const} mUInt sm\_sizeSamplerHeap = 8;}
\DoxyCodeLine{409 \};)}
\DoxyCodeLine{410 }
\DoxyCodeLine{411 \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{412 \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{413 \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{414 mIfVulkanEnabled(\textcolor{keyword}{struct} VulkanTask2dRender : \textcolor{keyword}{public} Task2dRender}
\DoxyCodeLine{415 \{}
\DoxyCodeLine{416     \textcolor{keyword}{explicit} VulkanTask2dRender(TaskData2dRender* a\_data);}
\DoxyCodeLine{417     \string~VulkanTask2dRender() \textcolor{keyword}{override};}
\DoxyCodeLine{418 }
\DoxyCodeLine{419     mBool add\_texture(resource::mRequestImage \textcolor{keyword}{const}\& a\_request)\textcolor{keyword}{ override }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{true};\}}
\DoxyCodeLine{420 }
\DoxyCodeLine{421     \textcolor{keywordtype}{void} create\_renderPassAndPipeline(mU32 a\_width, mU32 a\_height);}
\DoxyCodeLine{422 }
\DoxyCodeLine{423     \textcolor{keywordtype}{void} prepare() \textcolor{keyword}{override};}
\DoxyCodeLine{424 }
\DoxyCodeLine{425     \textcolor{keywordtype}{void} execute() \textcolor{keyword}{const override};}
\DoxyCodeLine{426 }
\DoxyCodeLine{427    \textcolor{keyword}{private}:}
\DoxyCodeLine{428     vulkanUploadBuffers m\_buffers;}
\DoxyCodeLine{429 }
\DoxyCodeLine{430     VkShaderModule m\_vertShaderModule;}
\DoxyCodeLine{431     VkShaderModule m\_fragShaderModule;}
\DoxyCodeLine{432 }
\DoxyCodeLine{433     VkPipelineLayout m\_pipelineLayout;}
\DoxyCodeLine{434     VkRenderPass     m\_renderPass;}
\DoxyCodeLine{435     VkPipeline       m\_graphicsPipeline;}
\DoxyCodeLine{436 }
\DoxyCodeLine{437     mUInt m\_i = 0;}
\DoxyCodeLine{438 \};)}
\DoxyCodeLine{439 }
\DoxyCodeLine{440 \}  \textcolor{comment}{// namespace m::render}}
\DoxyCodeLine{441 }
\DoxyCodeLine{442 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// M\_RenderTaskDearImGui}}
