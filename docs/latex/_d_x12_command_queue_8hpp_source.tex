...
\DoxyCodeLine{23     mU64 execute\_commandList(}
\DoxyCodeLine{24         Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList2> a\_commandList);}
\DoxyCodeLine{25 }
\DoxyCodeLine{26     mU64 signal\_fence();}
\DoxyCodeLine{27     mBool is\_fenceComplete(mU64 a\_fenceValue);}
\DoxyCodeLine{28     \textcolor{keywordtype}{void} wait\_fenceValue(mU64 a\_fenceValue);}
...
\DoxyCodeLine{40     \textcolor{keyword}{struct }\mbox{\hyperlink{structm_1_1dx12_1_1_d_x12_command_queue_1_1_command_allocator_entry}{CommandAllocatorEntry}}}
\DoxyCodeLine{41     \{}
\DoxyCodeLine{42         mU64                                           m\_fenceValue;}
...
\DoxyCodeLine{55     mU64                                       m\_fenceValue;}
\DoxyCodeLine{56 }
