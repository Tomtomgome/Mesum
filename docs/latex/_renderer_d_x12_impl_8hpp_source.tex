...
\DoxyCodeLine{93 }
\DoxyCodeLine{94     \mbox{\hyperlink{classm_1_1render_1_1_i_surface}{render::ISurface}}* getNew\_surface() \textcolor{keyword}{override};}
\DoxyCodeLine{95     \mbox{\hyperlink{structm_1_1render_1_1_i_resource}{render::IResource}}* getNew\_texture() \textcolor{keyword}{override};}
\DoxyCodeLine{96 \};}
\DoxyCodeLine{97 }
\DoxyCodeLine{98 \}  \textcolor{comment}{// namespace m::dx12}}
\DoxyCodeLine{99 }
\DoxyCodeLine{100 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// M\_RendererDX12Impl}}
