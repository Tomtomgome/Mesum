...
\DoxyCodeLine{104 \textcolor{keyword}{class }\mbox{\hyperlink{classm_1_1dx12_1_1m_swapchain_d_x12}{mSwapchainDX12}} final : \textcolor{keyword}{public} \mbox{\hyperlink{classm_1_1render_1_1m_i_swapchain}{render::mISwapchain}}}
\DoxyCodeLine{105 \{}
\DoxyCodeLine{106    \textcolor{keyword}{public}:}
\DoxyCodeLine{107     \mbox{\hyperlink{classm_1_1dx12_1_1m_swapchain_d_x12}{\string~mSwapchainDX12}}() \textcolor{keyword}{final} = \textcolor{keywordflow}{default};}
\DoxyCodeLine{108 }
\DoxyCodeLine{109     \textcolor{keywordtype}{void} init\_win32(render::Win32SurfaceInitData\& a\_data) \textcolor{keyword}{final};}
\DoxyCodeLine{110     \textcolor{keywordtype}{void} init\_x11(render::X11SurfaceInitData\& a\_data) \textcolor{keyword}{final};}
\DoxyCodeLine{111 }
...
\DoxyCodeLine{118 \textcolor{keyword}{class }\mbox{\hyperlink{classm_1_1dx12_1_1m_api_d_x12}{mApiDX12}} final : \textcolor{keyword}{public} \mbox{\hyperlink{classm_1_1render_1_1m_i_api}{render::mIApi}}}
\DoxyCodeLine{119 \{}
\DoxyCodeLine{120    \textcolor{keyword}{public}:}
\DoxyCodeLine{121     \textcolor{keyword}{static} \mbox{\hyperlink{group___core_gae30e3b08929d0b80e963d8d2f78ecee0}{memory::mMemoryType}} sm\_memoryType;}
\DoxyCodeLine{122     \textcolor{keyword}{static} \mbox{\hyperlink{classm_1_1memory_1_1m_object_allocator}{memory::mObjectAllocator}} sm\_mal;}
\DoxyCodeLine{123 }
\DoxyCodeLine{124    \textcolor{keyword}{public}:}
\DoxyCodeLine{125     \mbox{\hyperlink{classm_1_1dx12_1_1m_api_d_x12}{\string~mApiDX12}}() \textcolor{keyword}{final} = \textcolor{keywordflow}{default};}
\DoxyCodeLine{126 }
\DoxyCodeLine{127     \textcolor{keywordtype}{void} init() \textcolor{keyword}{final};}
\DoxyCodeLine{128     \textcolor{keywordtype}{void} destroy() \textcolor{keyword}{final};}
\DoxyCodeLine{129 }
\DoxyCodeLine{130     render::mResult<render::mISwapchain*> create\_swapchain() \textcolor{keyword}{final};}
\DoxyCodeLine{131 \};}
\DoxyCodeLine{132 }
\DoxyCodeLine{133 \}  \textcolor{comment}{// namespace m::dx12}}
\DoxyCodeLine{134 }
\DoxyCodeLine{135 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// M\_RendererDX12Impl}}
