...
\DoxyCodeLine{43     \textcolor{keyword}{static} \textcolor{keyword}{const} U8 scm\_numFrames = 3;}
\DoxyCodeLine{44 }
\DoxyCodeLine{45    \textcolor{keyword}{private}:}
\DoxyCodeLine{46     [[nodiscard]] UInt get\_syncInterval()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_vSync ? 1 : 0; \}}
\DoxyCodeLine{47 }
\DoxyCodeLine{48     [[nodiscard]] UInt get\_presentFlags()\textcolor{keyword}{ const}}
...
\DoxyCodeLine{60     Bool m\_vSync              = \textcolor{keyword}{true};}
\DoxyCodeLine{61     Bool m\_tearingSupported   = \textcolor{keyword}{false};}
\DoxyCodeLine{62 }
\DoxyCodeLine{63     ComPtr<IDXGISwapChain4> m\_swapChain;}
\DoxyCodeLine{64     ComPtr<ID3D12Resource>  m\_backBuffers[scm\_numFrames];}
\DoxyCodeLine{65     UInt                    m\_currentBackBufferIndex;}
\DoxyCodeLine{66 }
\DoxyCodeLine{67     ComPtr<ID3D12DescriptorHeap> m\_RTVDescriptorHeap;}
\DoxyCodeLine{68     UInt                         m\_RTVDescriptorSize;}
\DoxyCodeLine{69 }
...
\DoxyCodeLine{75     U64 m\_frameFenceValues[scm\_numFrames] = \{\};}
\DoxyCodeLine{76 }
\DoxyCodeLine{77     \textcolor{comment}{// Surface description}}
\DoxyCodeLine{78     U32 m\_clientWidth;}
\DoxyCodeLine{79     U32 m\_clientHeight;}
\DoxyCodeLine{80 \};}
\DoxyCodeLine{81 }
...
\DoxyCodeLine{90 }
\DoxyCodeLine{91     Bool get\_supportDearImGuiMultiViewports()\textcolor{keyword}{ override }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{true}; \}}
