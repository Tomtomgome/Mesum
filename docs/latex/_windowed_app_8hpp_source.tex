...
\DoxyCodeLine{67 \textcolor{preprocessor}{        m::internal\_run<AppClass>(cmdLine, \&data);                           \(\backslash\)}}
...
\DoxyCodeLine{84 \textcolor{preprocessor}{        m::internal\_run<AppClass>(cmdLine, \&data); \(\backslash\)}}
