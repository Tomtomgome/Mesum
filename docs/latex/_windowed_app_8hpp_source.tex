...
\DoxyCodeLine{24     \textcolor{keyword}{virtual} \mbox{\hyperlink{classm_1_1windows_1_1_i_window}{windows::IWindow}}* add\_newWindow(std::string a\_name, mU32 a\_width,}
\DoxyCodeLine{25                                             mU32 a\_height) = 0;}
\DoxyCodeLine{26 }
...
\DoxyCodeLine{43     m::mInt   m\_nCmdShow;}
\DoxyCodeLine{44 \};}
\DoxyCodeLine{45 }
...
\DoxyCodeLine{51 \textcolor{preprocessor}{    m::mInt WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR pCmdLine,  \(\backslash\)}}
\DoxyCodeLine{52 \textcolor{preprocessor}{                            m::mInt nCmdShow)                                \(\backslash\)}}
\DoxyCodeLine{53 \textcolor{preprocessor}{    \{                                                                        \(\backslash\)}}
\DoxyCodeLine{54 \textcolor{preprocessor}{        m::WindowedLaunchData data;                                          \(\backslash\)}}
\DoxyCodeLine{55 \textcolor{preprocessor}{        m::mCmdLine           cmdLine;                                       \(\backslash\)}}
\DoxyCodeLine{56 \textcolor{preprocessor}{        m::mInt               argc;                                          \(\backslash\)}}
\DoxyCodeLine{57 \textcolor{preprocessor}{        m::mChar**            argv = m::CommandLineToArgvA(pCmdLine, \&argc); \(\backslash\)}}
...
\DoxyCodeLine{78 \textcolor{preprocessor}{    int main(m::mInt argc, m::mChar** argv)        \(\backslash\)}}
\DoxyCodeLine{79 \textcolor{preprocessor}{    \{                                              \(\backslash\)}}
\DoxyCodeLine{80 \textcolor{preprocessor}{        m::WindowedLaunchData data;                \(\backslash\)}}
\DoxyCodeLine{81 \textcolor{preprocessor}{        m::mCmdLine           cmdLine;             \(\backslash\)}}
