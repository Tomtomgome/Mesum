...
\DoxyCodeLine{96     std::string \mbox{\hyperlink{group___log_ga3e8d8b07780e2a257355602b47f79ff4}{get\_time}}();}
\DoxyCodeLine{98     std::string \mbox{\hyperlink{group___log_ga4f8d02722b9085722cd2babce3c510e4}{get\_loglineHeader}}();}
\DoxyCodeLine{99 }
\DoxyCodeLine{101     std::stringstream \mbox{\hyperlink{group___log_ga11ebab8edadf2023987c805ce9576b15}{m\_logStream}};}
\DoxyCodeLine{103     LogPolicy* \mbox{\hyperlink{group___log_ga109c6d2d50e4a3e8da08a69b38dfbb16}{m\_policy}};}
\DoxyCodeLine{105     std::mutex \mbox{\hyperlink{group___log_gaf2ee2daa8a15910cde5824c736506ae0}{m\_mutexWrite}};}
\DoxyCodeLine{106 }
\DoxyCodeLine{108     \textcolor{keywordtype}{void} \mbox{\hyperlink{group___log_ga5dc93cb7cc1e460f1c1e7fb8c23634f5}{print\_impl}}();}
\DoxyCodeLine{109 }
\DoxyCodeLine{111 }
\DoxyCodeLine{117     \textcolor{keyword}{template} <\textcolor{keyword}{typename} First, \textcolor{keyword}{typename}... Rest>}
\DoxyCodeLine{118     \textcolor{keywordtype}{void} \mbox{\hyperlink{group___log_ga5dc93cb7cc1e460f1c1e7fb8c23634f5}{print\_impl}}(First a\_parm1, Rest... a\_parm);}
\DoxyCodeLine{119 }
\DoxyCodeLine{120    \textcolor{keyword}{private}:}
\DoxyCodeLine{122     \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{group___log_gac5d048908987c191774d4fa620984968}{m\_lineNumber}};}
\DoxyCodeLine{124     \mbox{\hyperlink{group___log_ga16bb065e762d9d22730e02ef41a8165f}{ChannelFilter}} \mbox{\hyperlink{group___log_ga1200f9c4218e3986e86c515c158fa8db}{m\_filter}} = -\/1;}
\DoxyCodeLine{126     \mbox{\hyperlink{group___log_ga13f51627936471940ede5666fd047313}{ChannelID}} \mbox{\hyperlink{group___log_ga35d8e6f355599eaf31c2a144780e0cf4}{m\_nextChannelID}} = 1;}
\DoxyCodeLine{127 \};}
\DoxyCodeLine{128 }
...
\DoxyCodeLine{155 \textcolor{keywordtype}{void} \mbox{\hyperlink{group___log_ga5dc93cb7cc1e460f1c1e7fb8c23634f5}{Logger<LogPolicy>::print\_impl}}()}
\DoxyCodeLine{156 \{}
...
\DoxyCodeLine{163 \textcolor{keywordtype}{void} \mbox{\hyperlink{group___log_ga5dc93cb7cc1e460f1c1e7fb8c23634f5}{Logger<LogPolicy>::print\_impl}}(First a\_parm1, Rest... a\_parm)}
\DoxyCodeLine{164 \{}
...
\DoxyCodeLine{170 std::string \mbox{\hyperlink{group___log_ga3e8d8b07780e2a257355602b47f79ff4}{Logger<LogPolicy>::get\_time}}()}
\DoxyCodeLine{171 \{}
...
\DoxyCodeLine{189 std::string \mbox{\hyperlink{group___log_ga4f8d02722b9085722cd2babce3c510e4}{Logger<LogPolicy>::get\_loglineHeader}}()}
\DoxyCodeLine{190 \{}
