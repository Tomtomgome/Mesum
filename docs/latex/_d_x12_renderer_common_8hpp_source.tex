...
\DoxyCodeLine{33 }
\DoxyCodeLine{34 \textcolor{keyword}{extern} MesumGraphicsApi \textcolor{keyword}{const} \mbox{\hyperlink{namespacem_1_1logging_ac4aaaa53dd22d25e9b24d091274b28a7}{logging::mChannelID}} DX\_RENDERER\_ID;}
\DoxyCodeLine{35 }
...
\DoxyCodeLine{41         \mbox{\hyperlink{group___core_ga5cbca1ff1eb730a016c7c63f94afa154}{mAssert}}(\textcolor{keyword}{false});}
\DoxyCodeLine{42     \}}
\DoxyCodeLine{43 \}}
\DoxyCodeLine{44 }
\DoxyCodeLine{45 \textcolor{keywordtype}{void} set\_dxgiDebugName(ComPtr<IDXGIObject> a\_dxgiObject, std::string a\_sName,}
\DoxyCodeLine{46                        \textcolor{keyword}{const} Int a\_lineNumber, \textcolor{keyword}{const} Char* a\_file);}
\DoxyCodeLine{47 }
\DoxyCodeLine{48 \textcolor{keywordtype}{void} set\_d3g12DebugName(ComPtr<ID3D12Object> a\_d3d12Object, std::string a\_sName,}
\DoxyCodeLine{49                         \textcolor{keyword}{const} Int a\_lineNumber, \textcolor{keyword}{const} Char* a\_file);}
\DoxyCodeLine{50 }
...
\DoxyCodeLine{68 }
\DoxyCodeLine{69 ComPtr<IDXGIAdapter4> get\_adapter(Bool a\_useWarp);}
\DoxyCodeLine{70 }
...
\DoxyCodeLine{89 U64                 signal\_fence(ComPtr<ID3D12CommandQueue> a\_commandQueue,}
\DoxyCodeLine{90                                  ComPtr<ID3D12Fence> a\_fence, U64\& a\_fenceValue);}
