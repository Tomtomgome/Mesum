...
void DX12Context::init(Bool a_useWarp)
{
    ...
    m_commandQueue =
        create_commandQueue(m_device, D3D12_COMMAND_LIST_TYPE_DIRECT);
}
...
void DX12Window::render()
{
    ...
    // Present
    {
        ...
        UINT syncInterval = DX12Context::gs_dx12Contexte
                                .get_syncInterval();  // m_vSync ? 1 : 0;
        UINT presentFlags =
            DX12Context::gs_dx12Contexte
